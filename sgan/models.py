...
class Decoder(nn.Module):
    ...
    def __init__(
        ...
        neighborhood_size=2.0, grid_size=8, device=None
    ):
...
class TrajectoryGenerator(nn.Module):
    def __init__(
        ...
        pool_every_timestep=True, dropout=0.0, bottleneck_dim=1024,
        activation='relu', batch_norm=True, neighborhood_size=2.0, grid_size=8, device=None
    ):
    ...
    def forward(self, obs_traj, obs_traj_rel, seq_start_end, user_noise=None):
        ...
        decoder_c = decoder_c.to(self.device)
